...
public class RwConfiguration {
    ...
    public ApiResponseWrapperAdvice apiResponseWrapperAdvice(RwProperties rwProperties, ObjectMapper objectMapper) {
        return new ApiResponseWrapperAdvice(rwProperties, objectMapper);
    }
}
