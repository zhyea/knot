...
public final class UsageNormalizationSupport {
    ...
    public static NormalizedUsage normalize(BillingUsage usage, BillingRuleEntity rule) {
        ...
        BillingAmount amount = calculateAmount(rule, normalizedUsage, modeEnum, unitPrice, unitSize);
    ...
    private static BillingAmount calculateAmount(BillingRuleEntity rule,
                                                 BillingUsage usage,
                                                 BillingModeEnum modeEnum,
