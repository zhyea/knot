...
export const messages = {
  ...
  "zh-TW": {
    ...
    route: {
      ...
      systemPlugins: "外掛管理",
      providers: "供應商",
      providerAccounts: "供應商帳戶",
      providerProfiles: "供應商資訊",
      modelManagementModels: "供應商模型",
      modelManagementModelPools: "模型池",
      modelManagementLogicalModels: "統一模型",
      modelManagementExternalModels: "外部模型",
      apps: "應用管理",
      routingConsumers: "消費者",
      routingRules: "規則列表",
  ...
  "en-US": {
    ...
    route: {
      ...
      modelManagementLogicalModels: "Unified Model",
  ...
  "fr-FR": {
    ...
    route: {
      ...
      systemPlugins: "Plugins",
      providers: "Fournisseurs",
      providerAccounts: "Comptes fournisseurs",
      providerProfiles: "Profils fournisseur",
      modelManagementModels: "Modèles fournisseur",
      modelManagementModelPools: "Pools de modèles",
      modelManagementLogicalModels: "Modèle unifié",
